...
| 应用 | 使用者 | 定位 | 核心功能 |
|------|--------|------|----------|
| 📅 **排课看板**  | 所有人（核心） | 教务日常操作台 | 时间轴周视图（教室 × 时段）、点卡片编辑/删除、多端实时同步、新手引导 |
| 🏫 **班课管理**  | 教务 & 顾问 | 批量排课工具 | 按班级/学期批量创建课程、右键复制课程、Excel 模板导入 |
| 🩺 **诊断课看板**（自搭） | 所有人 | 诊断课专项视图 | 从排课总台账自动筛选诊断课，独立看板呈现 |
| 📊 **关键数据看板**（自搭） | 管理者 | 经营数据总览 | 班课经营指标、外部系统数据自动汇聚 |
| 📖 **产品说明书**  | 新员工 | 使用文档 | 图文说明书 + 各应用快速上手引导 |
...
- Teable 线上地址、App ID、Base ID、Table ID 已脱敏为 `YOUR_TEABLE_*` 占位符（代码中）。
