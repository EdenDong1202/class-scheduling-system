...
> 本仓库主要展示 **产品设计思路、系统架构与流程设计**，源码由 Teable AI 生成、经人工迭代打磨（排课看板迭代了 10 个版本）。

🔗 **[点此查看交互式演示页面](https://<你的GitHub用户名>.github.io/<仓库名>/)** （开启 GitHub Pages 后生效）

---

## ✨ 这是什么？

教培分校的日常痛点：**排课靠 Excel + 微信群通知，教室冲突、教师撞档、家长问课时全靠人肉核对。**
